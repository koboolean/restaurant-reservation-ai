...
public class PromptConfig {
    ...
    public Map<WorkerType, String> workerPrompts(){
        return Map.of(
                WorkerType.RESERVATION, loadPrompt(reservationResource),
                WorkerType.SOMMELIER, loadPrompt(sommelierResource),
                WorkerType.CONCIERGE, loadPrompt(conciergeResource)
        );
    }
